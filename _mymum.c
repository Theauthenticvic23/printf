 ...
 * Return: Number of chars printed.
 */
int write_cyno(int negative, int ind, char lim[],
	int flags, int width, int precision, int size)
{
	...
	return (write_cynum(ind, lim, flags, width, precision,
		length, padd, extra_ch));
}

/**
 * write_cynum - Write a number using a bufffer
 ...
 */
int write_cynum(int ind, char lim[],
...
/**
 * write_cynu - Writes an unsigned number
 ...
 */
int write_cynu(int negative, int ind,
	char lim[],
	int flags, int width, int precision, int size)
{
...
/**
 * write_cynp - Write a memory address
 * @lim: Arrays of chars
 * @ind: Index at which the number starts in the lim
 ...
 * Return: Number of written chars.
 */
int write_cynp(char lim[], int ind, int length,
