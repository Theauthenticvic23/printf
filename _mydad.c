...
/**
 * cyn_is_print - Evaluates if a char is printable
 * @c: Char to be evaluated.
 *
 * Return: 1 if c is printable, 0 otherwise
 */
int cyn_is_print(char c)
{
	if (c >= 32 && c < 127)
		return (1);
...
/**
 * print_extra - Append ascci in hexadecimal code to lim
 * @lim: Array of chars.
 ...
 * Return: Always 3
 */
int print_extra(char ascii_code, char lim[], int i)
{
